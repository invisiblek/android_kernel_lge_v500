...
#if defined(CONFIG_SLIMPORT_ANX7808) && !defined(CONFIG_MACH_APQ8064_GK_KR)
	REGULATOR_SUPPLY("slimport_avdd",	NULL),
#else
...
VREG_CONSUMERS(L23) = {
	...
	REGULATOR_SUPPLY("cam1_vdig",		"4-0020"), /* GSBI4, Slave Addr: 0x20, s5k4e5ya */
